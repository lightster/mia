...
ActiveRecord::Schema.define(version: 20140505125607) do
  ...
  add_index "categories", ["user_id", "title"], name: "index_categories_on_user_id_and_title", unique: true
  ...
  create_table "tags_time_logs", force: true do |t|
    t.integer  "tag_id"
